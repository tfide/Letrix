...
from draw import draw_letras, gambiarra1, drawboxes_branco, draw_tempovitoria, draw_telavitoria,draw_teladerrota
...
# __________________________________________________________________________________________________________________________________________________________                    
        ...
        for i, (name, (tempo)) in enumerate(sorted(ranking, key=lambda x: x[1])):
            rank_text = font_rank.render(f"{name}    {tempo:.2f}", True, (corletra))
        ...
        # Loop para tocar a proxima musica caso acabe e volta para a primeira caso acabe
