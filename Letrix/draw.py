...
def gambiarra1():   #Gambiarra para tampar os primeiros quadrados
    for i in range(5):
            pygame.draw.rect(display, (35,35,35), (100*mult_posw + i * 110*mult_posw, 20*mult_posh, 100*mult_tam, 100*mult_tam), border_radius=10)
